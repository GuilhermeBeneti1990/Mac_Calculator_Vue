...
export default {
    ...
    methods: {
        clearMemory() {
            // This line make than object returns to original state
        ...
        addDigit(n) {
            ...
            const displayCurrentValue = currentValue + n

            this.displayValue = displayCurrentValue
            this.clearDisplay = false
            this.values[this.current] = displayCurrentValue
        }
    }
}
</script>
